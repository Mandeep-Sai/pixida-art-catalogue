...
describe("home component", () => {
  ...
  it("render content when there is data ", () => {
    ...
    const content = screen.getAllByTestId("searchresults_content");
  ...
  it("should  show pagination when total items are more than items per page ", () => {
    mockData.isError = false;
    mockData.isLoading = false;
    mockData.data = {
      elapsedMilliseconds: 0,
